 ...
 */
function sammenomaarhus_preprocess_node(&$vars, $hook) {
...
function sammenomaarhus_preprocess_node_pane_embedded(&$vars, $hook) {
...
function sammenomaarhus_preprocess_node_proposal(&$vars, $hook) {
  ...
  if ($vars['teaser']) {
    ...
    $vars['submitted'] = $vars['name'].', d. '.date("d/m/Y", $vars['created']);
  }
}
 ...
 */
/* function sammenomaarhus_css_alter(&$css) {
 ...
 */
function sammenomaarhus_preprocess_rate_template_thumbs_up(&$vars) {
 ...
 */
function sammenomaarhus_stats_block($metrics) {
  $output = '';
